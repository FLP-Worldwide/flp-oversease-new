...
export default function ContactForm({ t }) {
  ...
  if (submitted) {
    return (
      <section id="contact" className="py-24 px-6 bg-emerald-950">
      ...
      <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-16 relative z-10 items-center">
        ...
        <div className="text-white space-y-6">
          ...
          <div className="space-y-4 pt-8">
            <div className="flex items-center gap-4 p-4 bg-emerald-900/50 rounded-2xl border border-emerald-800">
              <div className="w-10 h-10 rounded-full bg-emerald-500 flex items-center justify-center text-emerald-950 font-bold">
                1
              </div>
        ...
        <div className="bg-white p-8 md:p-10 rounded-[40px] shadow-2xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <input
              ...
              className="w-full px-6 py-4 bg-gray-50 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500"
            />
            ...
            {userType === 'employer' && (
              <textarea
                ...
                className="w-full px-6 py-4 bg-gray-50 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 resize-none"
              />
            )}
            ...
            <div className="relative group">
              ...
              <label
                htmlFor="file-upload"
                className="flex flex-col items-center justify-center w-full h-32 border-2 border-dashed border-gray-300 rounded-xl cursor-pointer hover:border-emerald-500 hover:bg-emerald-50/50 transition-all"
              >
                <UploadCloud className="w-8 h-8 text-gray-400 group-hover:text-emerald-500 mb-2" />
